...
using XspfOpener.Pages;

namespace XspfOpener
{
    /// <summary>
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnFileActivated(FileActivatedEventArgs args)
        {
            ...
            rootFrame.Navigate(typeof(PlaylistPage), args.Files.First());

            // 确保当前窗口处于活动状态
            Window.Current.Activate();
        }

        private Frame GetOrCreateRootFrame(bool wasTerminated)
        {
            if(!backHandled)
            {
